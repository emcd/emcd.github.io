...
" Vim Bug: Assertions are broken in very magic mode.
...
highlight link mylangNumericPowerSign SpecialChar
syntax match mylangNumericPrefix "\v\\[bx]" contained
highlight link mylangNumericPrefix Special
syntax match mylangNumericSuffix "\v[Nij]" contained
highlight link mylangNumericSuffix SpecialChar
syntax match mylangRadixPoint "\v[\.'/]" contained
highlight link mylangRadixPoint Delimiter
...
syntax match mylangTextualInterpolation "\v[^\{]\zs\{\a(\w|\-|_)*\w?(\.\a(\w|\-|_)*\w?)*\}" contained contains=mylangIdentifier
highlight default link mylangTextualInterpolation SpecialChar
syntax match mylangByteswiseInterpolation "\v[^\{]\zs\{\a((\w|\-)*\a)?(\.\a((\w|\-)*\a)?)*\}" contained contains=mylangIdentifier
highlight default link mylangByteswiseInterpolation SpecialChar
...
syntax region mylangQEITextLiteral matchgroup=String start=/\\\@<!"/ skip=/\\"/ end=/"/ display contains=@mylangTextualEscapeSequence,mylangTextualInterpolation
syntax region mylangQEITextLiteral matchgroup=String start=/\\\@<!"""/ skip=/\\"/ end=/"""/ display contains=@mylangTextualEscapeSequence,mylangTextualInterpolation
highlight default link mylangQEITextLiteral Ignore

syntax region mylangQENITextLiteral matchgroup=String start=/\\\@<!'/ skip=/\\'/ end=/'/ display contains=@mylangTextualEscapeSequence
syntax region mylangQENITextLiteral matchgroup=String start=/\\\@<!'''/ skip=/\\'/ end=/'''/ display contains=@mylangTextualEscapeSequence
highlight default link mylangQENITextLiteral Ignore

syntax region mylangQNEITextLiteral matchgroup=String start=/\\\\"/ end=/"/ display contains=mylangTextualInterpolation
syntax region mylangQNEITextLiteral matchgroup=String start=/\\\\"""/ end=/"""/ display contains=mylangTextualInterpolation
highlight default link mylangQNEITextLiteral Ignore

syntax region mylangQNENITextLiteral matchgroup=String start=/\\\\'/ end=/'/ display
syntax region mylangQNENITextLiteral matchgroup=String start=/\\\\'''/ end=/'''/ display
highlight default link mylangQNENITextLiteral Ignore

syntax region mylangEITextLiteralClause start=/\v.*\\":.*$/ skip=/\v^(\s+|$)/ end=/\v^(\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangTextLiteralCaputPreDelimiter,@mylangTextualEscapeSequence,mylangTextualInterpolation
syntax region mylangEITextLiteralClause start=/\v^\z(\s*).*\\":.*$/ skip=/\v^(\z1\s+|$)/ end=/\v^(\z1\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangTextLiteralCaputPreDelimiter,@mylangTextualEscapeSequence,mylangTextualInterpolation
highlight default link mylangEITextLiteralClause String

syntax region mylangENITextLiteralClause start=/\v.*\\':.*$/ skip=/\v^(\s+|$)/ end=/\v^(\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangTextLiteralCaputPreDelimiter,@mylangTextualEscapeSequence
syntax region mylangENITextLiteralClause start=/\v^\z(\s*).*\\':.*$/ skip=/\v^(\z1\s+|$)/ end=/\v^(\z1\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangTextLiteralCaputPreDelimiter,@mylangTextualEscapeSequence
highlight default link mylangENITextLiteralClause String

syntax region mylangNEITextLiteralClause start=/\v.*\\\\\\":.*$/ skip=/\v^(\s+|$)/ end=/\v^(\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangTextLiteralCaputPreDelimiter,mylangTextualInterpolation
syntax region mylangNEITextLiteralClause start=/\v^\z(\s*).*\\\\\\":.*$/ skip=/\v^(\z1\s+|$)/ end=/\v^(\z1\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangTextLiteralCaputPreDelimiter,mylangTextualInterpolation
highlight default link mylangNEITextLiteralClause String

syntax region mylangNENITextLiteralClause start=/\v.*\\\\\\':.*$/ skip=/\v^(\s+|$)/ end=/\v^(\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangTextLiteralCaputPreDelimiter
syntax region mylangNENITextLiteralClause start=/\v^\z(\s*).*\\\\\\':.*$/ skip=/\v^(\z1\s+|$)/ end=/\v^(\z1\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangTextLiteralCaputPreDelimiter
highlight default link mylangNENITextLiteralClause String

syntax region mylangQEIBytesLiteral matchgroup=String start=/\\B"/ skip=/\\"/ end=/"/ display contains=@mylangByteswiseEscapeSequence,mylangByteswiseInterpolation
syntax region mylangQEIBytesLiteral matchgroup=String start=/\\B"""/ skip=/\\"/ end=/"""/ display contains=@mylangByteswiseEscapeSequence,mylangByteswiseInterpolation
highlight default link mylangQEIBytesLiteral Ignore

syntax region mylangQENIBytesLiteral matchgroup=String start=/\\B'/ skip=/\\'/ end=/'/ display contains=@mylangByteswiseEscapeSequence
syntax region mylangQENIBytesLiteral matchgroup=String start=/\\B'''/ skip=/\\'/ end=/'''/ display contains=@mylangByteswiseEscapeSequence
highlight default link mylangQENIBytesLiteral Ignore

syntax region mylangQNEIBytesLiteral matchgroup=String start=/\\B\\\\"/ end=/"/ display contains=mylangByteswiseInterpolation
syntax region mylangQNEIBytesLiteral matchgroup=String start=/\\B\\\\"""/ end=/"""/ display contains=mylangByteswiseInterpolation
highlight default link mylangQNEIBytesLiteral Ignore

syntax region mylangQNENIBytesLiteral matchgroup=String start=/\\B\\\\'/ end=/'/ display
syntax region mylangQNENIBytesLiteral matchgroup=String start=/\\B\\\\'''/ end=/'''/ display
highlight default link mylangQNENIBytesLiteral Ignore

syntax region mylangEIBytesLiteralClause start=/\v.*\\B\\":.*$/ skip=/\v^(\s+|$)/ end=/\v^(\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangBytesLiteralCaputPreDelimiter,@mylangByteswiseEscapeSequence,mylangByteswiseInterpolation
syntax region mylangEIBytesLiteralClause start=/\v^\z(\s*).*\\B\\":.*$/ skip=/\v^(\z1\s+|$)/ end=/\v^(\z1\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangBytesLiteralCaputPreDelimiter,@mylangByteswiseEscapeSequence,mylangByteswiseInterpolation
highlight default link mylangEIBytesLiteralClause String

syntax region mylangENIBytesLiteralClause start=/\v.*\\B\\':.*$/ skip=/\v^(\s+|$)/ end=/\v^(\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangBytesLiteralCaputPreDelimiter,@mylangByteswiseEscapeSequence
syntax region mylangENIBytesLiteralClause start=/\v^\z(\s*).*\\B\\':.*$/ skip=/\v^(\z1\s+|$)/ end=/\v^(\z1\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangBytesLiteralCaputPreDelimiter,@mylangByteswiseEscapeSequence
highlight default link mylangENIBytesLiteralClause String

syntax region mylangNEIBytesLiteralClause start=/\v.*\\B\\\\\\":.*$/ skip=/\v^(\s+|$)/ end=/\v^(\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangBytesLiteralCaputPreDelimiter,mylangByteswiseInterpolation
syntax region mylangNEIBytesLiteralClause start=/\v^\z(\s*).*\\B\\\\\\":.*$/ skip=/\v^(\z1\s+|$)/ end=/\v^(\z1\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangBytesLiteralCaputPreDelimiter,mylangByteswiseInterpolation
highlight default link mylangNEIBytesLiteralClause String

syntax region mylangNENIBytesLiteralClause start=/\v.*\\B\\\\\\':.*$/ skip=/\v^(\s+|$)/ end=/\v^(\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangBytesLiteralCaputPreDelimiter
syntax region mylangNENIBytesLiteralClause start=/\v^\z(\s*).*\\B\\\\\\':.*$/ skip=/\v^(\z1\s+|$)/ end=/\v^(\z1\s+)@!/he=s-1,re=s-1 keepend fold contains=mylangBytesLiteralCaputPreDelimiter
